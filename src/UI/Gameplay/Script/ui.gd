...
@onready var ammo: Label = $PlayerBar/VBoxContainer/HBoxContainer/Ammo
@onready var hp_bar: ProgressBar = $"PlayerBar/VBoxContainer/HP Bar"
@onready var dash: TextureProgressBar = $PlayerBar/VBoxContainer/Dash
